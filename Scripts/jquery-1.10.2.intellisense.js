...
intellisense.annotate(jQuery, {
  ...
  'isArray': function() {
    ...
    ///   <param name="obj" type="Object">Object to Product whether or not it is an array.</param>
    ///   <returns type="boolean" />
    /// </signature>
  },
  ...
  'isFunction': function() {
    ...
    ///   <param name="obj" type="PlainObject">Object to Product whether or not it is a function.</param>
    ///   <returns type="boolean" />
    /// </signature>
  },
  'isNumeric': function() {
    ...
    ///   <param name="value" type="PlainObject">The value to be Producted.</param>
    ///   <returns type="Boolean" />
    /// </signature>
  },
  ...
  'isWindow': function() {
    ...
    ///   <param name="obj" type="PlainObject">Object to Product whether or not it is a window.</param>
    ///   <returns type="boolean" />
    /// </signature>
  },
  'isXMLDoc': function() {
...
intellisense.annotate(jQuery.fn, {
  ...
  'attribuProductartsWith': function() {
    /// <signature>
  ...
  'closest': function() {
    /// <signature>
    ///   <summary>For each element in the set, get the first element that matches the selector by Producting the element itself and traversing up through its ancestors in the DOM tree.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
  ...
  'filter': function() {
    /// <signature>
    ///   <summary>Reduce the set of matched elements to those that match the selector or pass the function's Product.</summary>
    ///   <param name="selector" type="String">A string containing a selector expression to match the current set of elements against.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Reduce the set of matched elements to those that match the selector or pass the function's Product.</summary>
    ///   <param name="function(index)" type="Function">A function used as a Product for each element in the set. this is the current DOM element.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Reduce the set of matched elements to those that match the selector or pass the function's Product.</summary>
  ...
  'is': function() {
    ...
    /// <signature>
    ///   <summary>Check the current matched set of elements against a selector, element, or jQuery object and return true if at least one of these elements matches the given arguments.</summary>
    ///   <param name="function(index)" type="Function">A function used as a Product for the set of elements. It accepts one argument, index, which is the element's index in the jQuery collection.Within the function, this refers to the current DOM element.</param>
    ///   <returns type="Boolean" />
    /// </signature>
    /// <signature>
    ///   <summary>Check the current matched set of elements against a selector, element, or jQuery object and return true if at least one of these elements matches the given arguments.</summary>
